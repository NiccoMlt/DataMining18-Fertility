...
\begin{itemize}
  ...
  \item \texttt{childish-disease}:
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.75\textwidth]{fig/disease.eps}%
      \caption{%
  ...
  \item \texttt{trauma}:
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.75\textwidth]{fig/trauma.eps}%
      \caption{%
...
\begin{figure}[H]
  \centering
  \adjincludegraphics[width=.95\linewidth,trim=0 {.04\height} 0 {.3\height},clip]{fig/j48.eps}%
...
\begin{figure}[H]
  \centering
  \adjincludegraphics[width=.95\linewidth,trim=0 {.1\height} {.285\width} {.32\height},clip]{fig/ibk.eps}%
...
\begin{figure}[H]
  \centering
  \adjincludegraphics[width=.95\linewidth,trim=0 {.1\height} {.285\width} {.32\height},clip]{fig/ibk9.eps}%
...
\begin{figure}[H]
  \centering
  \adjincludegraphics[width=.9\linewidth,trim=0 {.09\width} {.285\width} {.32\height},clip]{fig/ibk3-num.eps}%
...
\begin{figure}[H]
  \centering
  \adjincludegraphics[width=.9\linewidth,trim=0 {.09\width} {.285\width} {.32\height},clip]{fig/ibk5-num.eps}%
